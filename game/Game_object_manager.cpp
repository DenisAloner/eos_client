...
void GameObjectManager::init()
{
	...
	m_effect_string[interaction_e::evasion_skill] = "навык уклонени€";
	m_effect_string[interaction_e::weapon_range] = "дальность";
	m_effect_string[interaction_e::vision] = "зрение";
	m_effect_string[interaction_e::vision_component] = "компонент зрени€";
	...
	m_effect_prefix_string[effect_prefix_e::state_change] = "изменить состо€ние";
