...
GUI_game_console::GUI_game_console(Game_log& log)
    : m_log(log)
{
    m_styles.emplace_back(10, 19, RGBA_t(0.0, 0.8, 0.0, 1.0));
    m_styles.emplace_back(10, 19, RGBA_t(0.3, 0.8, 0.8, 1.0));
    m_styles.emplace_back(10, 19, RGBA_t(0.8, 0.0, 0.0, 1.0));
